...
class RecipeListViewModelTest {
    ...
    fun test_success() = runTest {
        ...
        `when`(getAllRecipeUseCase.invoke("chicken")).thenReturn(flowOf(NetworkResult.Success(data = getRecipeResponse())))
    ...
    @Test
    fun testNavigateToRecipeDetails() = runTest {
        val viewModel = RecipeListViewModel(getAllRecipeUseCase)
    ...
    @Test
    fun testNavigateToFavoriteScreen() = runTest {
        val viewModel = RecipeListViewModel(getAllRecipeUseCase)
